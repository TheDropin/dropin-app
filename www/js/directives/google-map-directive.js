angular.module('directives').directive("googleMap", function ($rootScope, $compile, googleMapsLoader) {
...
angular.module('directives').directive("googleMap", function ($rootScope, $ionicLoading, $compile, googleMapsLoader, $ionicPlatform) {
